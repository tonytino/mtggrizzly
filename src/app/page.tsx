  ...
  return (
    <React.Fragment>
      ...
      <div>
        ...
        <Link
          className='mx-auto my-4 block w-[var(--Set--width-mobile)] rounded-md bg-emerald-600 py-4 text-center text-xl font-semibold text-slate-100 dark:bg-white dark:text-sky-800 dark:hover:text-sky-600 lg:my-8 lg:w-[var(--Set--width-desktop)]'
          href='/sets'
        >
          All Sets
        </Link>
