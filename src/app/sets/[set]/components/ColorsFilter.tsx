...
/**
 * Renders toggles for each card type that update the `permittedColors` value of `CardsQueryContext`
 */
export function ColorsFilter() {
  const { permittedColors, setQueries } = React.useContext(CardsQueryContext);
